          ...
          <div style="flex:1;padding:14px 16px 12px;display:flex;flex-direction:column;justify-content:space-between;">
            <div>
              <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-bottom:6px;margin-top:2px;">
                ...
                ${unit.batteryHealth && unit.batteryHealth !== "n_a" ? `<span style="font-size:10px;font-weight:700;background:#d1fae5;color:#065f46;padding:2px 8px;border-radius:6px;">🔋 Batería: ${unit.batteryHealth === "good" ? "Buena" : "Regular"}</span>` : ""}
              </div>
              ...
              <div style={{ flex: 1, padding: "14px 16px 12px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap", marginBottom: "6px", marginTop: "2px" }}>
                    ...
                    {unit.batteryHealth && unit.batteryHealth !== "n_a" && <span style={{ fontSize: "10px", fontWeight: 700, background: "#d1fae5", color: "#065f46", padding: "2px 8px", borderRadius: "6px" }}>🔋 Bateria: {unit.batteryHealth === "good" ? "Buena" : "Regular"}</span>}
