...
const NAV_ITEMS = [
  ...
  { label: "Dashboard", href: "/dashboard", icon: LayoutDashboard, keywords: "dashboard panel estadísticas" },
  { label: "Ventas y Cotizaciones", href: "/sales", icon: ShoppingBag, keywords: "ventas cotizaciones venta pos" },
  { label: "Pedidos / Entregas", href: "/orders", icon: Truck, keywords: "pedidos entregas repartidor" },
  { label: "Inventario", href: "/inventory", icon: Package, keywords: "inventario stock productos" },
  { label: "Clientes", href: "/customers", icon: Users, keywords: "clientes cliente" },
  { label: "Compras / Proveedores", href: "/purchases", icon: ClipboardList, keywords: "compras proveedores proveedor" },
  { label: "Finanzas", href: "/finance", icon: DollarSign, keywords: "finanzas caja apertura cierre" },
  ...
  { label: "Gastos", href: "/expenses", icon: Receipt, keywords: "gastos gasto egreso" },
  { label: "Informes", href: "/reports", icon: BarChart2, keywords: "reportes informes reporte" },
  { label: "Análisis de Negocio", href: "/analysis", icon: FileText, keywords: "análisis negocio tendencia" },
  { label: "Producción", href: "/production", icon: Factory, keywords: "producción fábrica producir" },
];
